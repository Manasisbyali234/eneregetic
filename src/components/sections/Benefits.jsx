...
const Benefits = () => {
  return (
    <motion.section
      className="py-16 bg-orange-50 text-slate-800"
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div variants={staggerContainer} className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <motion.div variants={fadeInUp} whileHover={{ y: -6 }} className="bg-white p-8 rounded-xl hover:bg-orange-50 transition duration-300 border-t-4 border-orange-500 shadow-md">
            ...
            <h3 className="text-xl font-bold mb-4 text-slate-800">Increased Efficiency</h3>
          ...
          <motion.div variants={fadeInUp} whileHover={{ y: -6 }} className="bg-white p-8 rounded-xl hover:bg-blue-50 transition duration-300 border-t-4 border-blue-500 shadow-md">
            ...
            <h3 className="text-xl font-bold mb-4 text-slate-800">Reduced Costs</h3>
            <p className="text-slate-600">
          ...
          <motion.div variants={fadeInUp} whileHover={{ y: -6 }} className="bg-white p-8 rounded-xl hover:bg-green-50 transition duration-300 border-t-4 border-green-500 shadow-md">
            ...
            <h3 className="text-xl font-bold mb-4 text-slate-800">Sustainable Growth</h3>
            <p className="text-slate-600">
          ...
          <motion.div variants={fadeInUp} whileHover={{ y: -6 }} className="bg-white p-8 rounded-xl hover:bg-purple-50 transition duration-300 border-t-4 border-purple-500 shadow-md">
            ...
            <h3 className="text-xl font-bold mb-4 text-slate-800">Quality Assurance</h3>
            <p className="text-slate-600">
              Ensure consistent quality with products from trusted manufacturers backed by comprehensive warranties and support
            </p>
          </motion.div>

          <motion.div variants={fadeInUp} whileHover={{ y: -6 }} className="bg-white p-8 rounded-xl hover:bg-yellow-50 transition duration-300 border-t-4 border-yellow-500 shadow-md">
            ...
            <h3 className="text-xl font-bold mb-4 text-slate-800">Expert Guidance</h3>
            <p className="text-slate-600">
              Benefit from decades of industry expertise with personalized consultation and technical support for your projects
            </p>
          </motion.div>

          <motion.div variants={fadeInUp} whileHover={{ y: -6 }} className="bg-white p-8 rounded-xl hover:bg-red-50 transition duration-300 border-t-4 border-red-500 shadow-md">
            ...
            <h3 className="text-xl font-bold mb-4 text-slate-800">Fast Implementation</h3>
            <p className="text-slate-600">
