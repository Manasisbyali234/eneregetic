          ...
          <div className="relative h-64 md:h-96">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent flex items-center">
              <div className="pl-8 md:pl-16">
                <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">Steam & Heat Solutions</h1>
                <p className="text-xl text-gray-200 max-w-xl">Energy-Efficient Heating and Steam Generation</p>
              </div>
            </div>
          </div>
