          ...
          <div className="relative h-64 md:h-96">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-orange-900/50 to-transparent flex items-center">
              <div className="pl-6 md:pl-16">
                <h1 className="text-3xl md:text-6xl font-bold text-white mb-4">Industrial Products</h1>
                <p className="text-lg md:text-xl text-orange-100 max-w-xl">Comprehensive Solutions for Every Industrial Need</p>
              </div>
            </div>
          </div>
