        ...
        >
          <div className="relative h-64 md:h-96">
            <img 
              ...
              alt="Kaeser Compressed Air Systems" 
              className="w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent flex items-center">
              <div className="pl-8 md:pl-16">
                <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">Kaeser</h1>
                <p className="text-xl text-gray-200 max-w-xl">World-renowned Compressed Air Systems</p>
              </div>
            </div>
          </div>
